...
// LED0..LED15 PWM Registers
// LEDn_ON_L  = base + 4*n + 0
// LEDn_ON_H  = base + 4*n + 1
// LEDn_OFF_L = base + 4*n + 2
// LEDn_OFF_H = base + 4*n + 3
...
// ===================== Optional Helper Macros (nice to have) =====================

// Base address for LED channel registers (LED0_ON_L)
#define PCA9685_LED0_BASE      0x06

// Compute register addresses for channel n (0..15)
#define PCA9685_LEDn_ON_L(n)   (uint8_t)(PCA9685_LED0_BASE + 4u*(n) + 0u)
#define PCA9685_LEDn_ON_H(n)   (uint8_t)(PCA9685_LED0_BASE + 4u*(n) + 1u)
#define PCA9685_LEDn_OFF_L(n)  (uint8_t)(PCA9685_LED0_BASE + 4u*(n) + 2u)
#define PCA9685_LEDn_OFF_H(n)  (uint8_t)(PCA9685_LED0_BASE + 4u*(n) + 3u)
