...
enum PCA9685_COMMANDS {
	...
	PCA9685_SET_OUTPUT_MASK // Applies the vehicle lights and horn bitmask
};
...
private:
    // Private Functions
    HAL_StatusTypeDef ApplyLightCommand(uint8_t lightcommand);
    ...
    bool pcaReady;                                      // True after complete initialization
};
