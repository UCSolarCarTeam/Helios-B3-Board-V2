...
// =========================
static inline uint8_t PCA9685_ChannelOnL(uint8_t ch)
{
    return (uint8_t)(PCA9685_LED0_ON_L + 4U * ch);
}

static inline uint8_t PCA9685_ChannelOnH(uint8_t ch)
{
    return (uint8_t)(PCA9685_LED0_ON_H + 4U * ch);
}

static inline uint8_t PCA9685_ChannelOffL(uint8_t ch)
{
    return (uint8_t)(PCA9685_LED0_OFF_L + 4U * ch);
}

static inline uint8_t PCA9685_ChannelOffH(uint8_t ch)
{
    return (uint8_t)(PCA9685_LED0_OFF_H + 4U * ch);
}
